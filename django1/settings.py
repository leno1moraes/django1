...
SECRET_KEY = 'django-insecure-ct+3&o#pa(@qova6s#ha-)3&v@r(9rwt&e=3n)8a+nob_zefe%'

# SECURITY WARNING: don't run with debug turned on in production!
#TRUE => modo desenvolvimento | FALSE => modo produção
DEBUG = False

ALLOWED_HOSTS = ['*'] #www.meu-site-oficial.com
